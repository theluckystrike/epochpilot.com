...
(function() {
  ...
  function initShare() {
    ...
    var parent = container.closest('section') || container.parentNode;
    if (parent) parent.insertBefore(shareBar, container.nextSibling);
    ...
    container.addEventListener('click', function(e) {
      ...
      if (btn.dataset && btn.dataset.copy) return;
